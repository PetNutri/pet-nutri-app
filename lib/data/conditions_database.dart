...
const List<PetCondition> conditionsDatabase = [
  ...
  PetCondition(
    id: 'bird_respiratory_eye',
    name: 'Infekcije sinusa i očiju',
    category: ConditionCategory.exotic,
    description: 'Kod ptica su sinusne šupljine usko povezane sa očima, pa se svaka jača respiratorna infekcija manifestuje na kapcima i očnoj jabučici. Najčešće je uzrokovana bakterijama ili nedostatkom vitamina A.',
    affectedSpecies: [PetType.bird],
    icon: '👁️',
    symptoms: [
      'Natečeno oko i kapci', 
      'Crvenilo oka (konjunktivitis)', 
      'Iscedak iz nozdrva', 
      'Kijanje', 
      'Ptica drži oko zatvoreno',
      'Češanje glave o prečke'
    ],
    guidelines: [
      DietaryGuideline(nutrient: 'Vitamin A', recommendation: 'high', reason: 'Kritičan za regeneraciju sluzokože i vid.'),
      DietaryGuideline(nutrient: 'Hidratacija', recommendation: 'high', reason: 'Pomaže u razređivanju iscetka iz sinusa.'),
    ],
    goodIngredients: ['šargarepa', 'crvena paprika', 'batat', 'maslačak'],
    badIngredients: ['samo proso', 'hladna voda', 'promaja'],
    treatment: 'Veterinar obično propisuje antibiotske kapi (npr. Tobrex) i oralne antibiotike. Kod kuće je važno održavati vlažnost vazduha i ispirati oko mlakim fiziološkim rastvorom. Ako ptica teško diše, potrebna je hitna inhalacija.',
  ),
  PetCondition(
    id: 'ich_fish',
    name: 'Ihtioftirijaza (Bele tačke)',
    category: ConditionCategory.exotic,
    description: 'Najpoznatija bolest akvarijumskih riba koju izaziva parazit Ichthyophthirius multifiliis. Veoma je zarazna i brzo se širi akvarijumom.',
    affectedSpecies: [PetType.aquarium],
    icon: '⚪',
    symptoms: [
      'Sitne bele tačke po telu (kao posuto solju)', 
      'Riba se trlja o pesak i kamenje', 
      'Ubrzano pomeranje škrga', 
      'Gubitak apetita'
    ],
    guidelines: [
      DietaryGuideline(nutrient: 'Imunitet', recommendation: 'high', reason: 'Riba mora imati snage da se izbori sa parazitom.'),
    ],
    goodIngredients: ['živa hrana (artemija)', 'vitaminski dodaci za vodu'],
    badIngredients: ['nekvalitetni listići', 'prekomerno hranjenje'],
    treatment: 'Postepeno podizanje temperature vode na 28-30°C (ubrzava ciklus parazita) i tretman preparatima na bazi malahitnog zelenila. Obavezno ugasiti svetlo i ukloniti aktivni ugalj iz filtera tokom lečenja.',
  ),
  PetCondition(
    id: 'fin_rot',
    name: 'Truljenje peraja',
    category: ConditionCategory.exotic,
    description: 'Bakterijska infekcija koja razjeda tkivo peraja. Obično je znak loše higijene u akvarijumu ili prenaseljenosti.',
    affectedSpecies: [PetType.aquarium],
    icon: '🐟',
    symptoms: [
      'Irzana i pokidana peraja', 
      'Bele ili crvene ivice na krajevima peraja', 
      'Riba je letargična'
    ],
    guidelines: [
      DietaryGuideline(nutrient: 'Čistoća vode', recommendation: 'critical', reason: 'Bakterije se razmnožavaju u prljavoj vodi.'),
    ],
    goodIngredients: ['visokokvalitetni peleti', 'redovna zamena vode'],
    badIngredients: ['amonijak', 'nitriti', 'ostaci hrane na dnu'],
    treatment: 'Obavezna zamena 30% vode. Korišćenje antibakterijskih lekova (npr. Sera Baktopur). Dodavanje malo akvarijumske soli može pomoći u regeneraciji tkiva.',
  ),
];
